...
## Chronic Absenteeism {.tabset .tabset-fade}
...
* Black, NHPI, and NH-AIAN students are 3 times more likely to be chronically absent than the group with the lowest rate.
...
```
* NH-AIAN, NH-Blac, Latinx, and NHPI students have below average graduation rates. Black  and AIAN student graduation rates are 16 percentage points lower than the group with the highest rate.
...
```
* Most Central Valley counties exhibit below average performance for this measure with rates lower than 40%. 
...
```
* Modoc County is the lowest performing on this measure with less than 25% of it's students scoring Proficient or Better in Math.
