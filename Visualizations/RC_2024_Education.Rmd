...
c_4_chart %>%
  ...
  hc_yAxis(title = list(text = "Performance (Low -> High)"), max = 4, min = -4) %>% 
  hc_caption(
    text = "Data source: CALIFORNIA DEPARTMENT OF EDUCATION (2022-2023)<br>Students scoring proficient or advanced on the third grade Mathematics test (Smarter Balanced and California Alternate Assessment) as a percentage of all third graders tested.<br>A Disparity Rank of 1 represents the most disparate. A Performance Rank of 1 represents the best outcomes.",
    align = "center"
     ) %>% #hc_size(height=400,width=700) %>% 
  hc_legend(element_blank) %>% hc_add_theme(rc_theme)
...
```
*Most Central Valley and Northern California counties have lower than average performance on this measure.
...
```
* Statewide, two groups emerge. In the first group, about one in three AIAN, Black, Latinx, and NHPI students scored proficient. While in the second group, more than 50% of Asian, Filipinx, White, Two or More Races third graders scored proficient in math. 
