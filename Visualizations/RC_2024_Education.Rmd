...
setwd("W:/Project/RACE COUNTS/2022_v4/Visualizations/") 
...
rc_theme <- hc_theme(
    # race counts colors
  colors = c("green", "orange", "red", "yellow"),
  chart = list(
...
c_index_z <- st_read(con, query = "SELECT * FROM v4.arei_educ_index_2022")
