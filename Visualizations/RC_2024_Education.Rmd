...
c_2_chart %>% 
  ...
  hc_yAxis(title = list(text = "Performance (Low -> High)"), max = 4, min = -4) %>% 
  hc_caption(
    text = "Data source: CALIFORNIA DEPARTMENT OF EDUCATION (2022-23)<br> Graduates are students who graduate with either a traditional high school diploma,<br>an adult education high school diploma, or have passed the California High School Proficiency Exam.<br>A Disparity Rank of 1 represents the most disparate. A Performance Rank of 1 represents the best outcomes.",
    align = "center"
     ) %>% #hc_size(height=400,width=700) %>% 
  hc_legend(element_blank) %>% hc_add_theme(rc_theme)

```
* Mono, Nevada, Inyo, and San Francisco Counties have among the highest racial disparities and lowest performance on high school graduation rates.
