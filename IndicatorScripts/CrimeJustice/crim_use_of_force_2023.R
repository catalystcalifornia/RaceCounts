...
list.of.packages <- c("DBI", "tidyverse","RPostgreSQL", "tidycensus", "readxl", "sf", "janitor", "stringr", "rlist", "pipeR", "data.table", "usethis")
...
library(janitor)
library(stringr)
library(rlist) # working within list
library(pipeR) # data grouping within list
