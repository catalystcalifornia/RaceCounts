...
list.of.packages <- c("readr","tidyr","dplyr","DBI","RPostgreSQL","tidycensus")
...
#Get Suspension data, handle na's, ensure DistrictCode is coded as character
filepath = "https://www3.cde.ca.gov/demo-downloads/discipline/susp2021.txt"
...
county_table_name <- "arei_educ_suspension_county_2022"
state_table_name <- "arei_educ_suspension_state_2022"

indicator <- "Unduplicated students suspended, cumulative enrollment, and unduplicated suspension rate. This data is"

source <- "CDE 2020-21 https://www.cde.ca.gov/ds/ad/filessd.asp"
