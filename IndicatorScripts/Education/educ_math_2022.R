...
df_subset <- df %>% filter(grade == "03" & test_id == "02" & race %in% c("001","074","075","076","077","078","079","080","144")
                           & type_id %in% c("04", "05")) %>%    
...
county_table_name <- "arei_educ_gr3_math_scores_county_2022"
state_table_name <- "arei_educ_gr3_math_scores_state_2022"
