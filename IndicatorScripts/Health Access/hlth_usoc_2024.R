...
races_df = read.xlsx(paste0("USOC/",curr_yr,"/USOC_nh.xlsx"), sheet=1, startRow=8, rows=c(8,10:12,14,16:19,21,23))
...
pacisl_df = read.xlsx(paste0("USOC/",curr_yr,"/USOC_pacisl.xlsx"), sheet=1, startRow=8, rows=c(8,10,12))
...
county_table_name <- "arei_hlth_usual_source_of_care_county_2024"
state_table_name <- "arei_hlth_usual_source_of_care_state_2024"
