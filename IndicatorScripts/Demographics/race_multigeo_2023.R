...
if (table_code != "DP05") {
  ...
  indicator <- "City, County, and State population by race/ethnicity for RC Place and Race pages"        # See most recent Indicator Methodology for indicator description
