...
county_table_name <- paste0("arei_hben_haz_weighted_avg_county_", rc_yr)
state_table_name <- paste0("arei_hben_haz_weighted_avg_state_", rc_yr)
city_table_name <- paste0("arei_hben_haz_weighted_avg_city_", rc_yr)
leg_table_name <- paste0("arei_hben_haz_weighted_avg_leg_", rc_yr)
