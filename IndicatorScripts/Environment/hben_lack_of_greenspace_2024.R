...
ind_df <- read.csv("W:/Data/Built Environment/NationalLandCoverDatabase/2021/nlcd_census_tract_pct_impervious_2021.txt",
...
county_table_name <- "arei_hben_lack_of_greenspace_county_2024"
state_table_name <- "arei_hben_lack_of_greenspace_state_2024"
city_table_name <- "arei_hben_lack_of_greenspace_city_2024"
rc_schema <- 'v6'
...
source <- "Multi-Resolution Land Characteristics Consortium, National Land Cover Database (2021), ACS DP05 (2017-2021)"
