### Proximity to Hazards (Weighted Avg) RC v5 ###
...
county_table_name <- "arei_hben_haz_weighted_avg_county_2023"
state_table_name <- "arei_hben_haz_weighted_avg_state_2023"
city_table_name <- "arei_hben_haz_weighted_avg_city_2023"
rc_schema <- 'v5'
