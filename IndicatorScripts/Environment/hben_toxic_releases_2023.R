### Toxic Releases (Weighted Avg) RC v5 ###
...
county_table_name <- "arei_hben_toxic_release_county_2023"
state_table_name <- "arei_hben_toxic_release_state_2023"
city_table_name <- "arei_hben_toxic_release_city_2023"
rc_schema <- 'v5'
