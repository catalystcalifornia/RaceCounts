...
ind_df <- st_read(conn, query = paste0("select ct_geoid AS geoid, tox_rel from built_environment.oehha_ces4_tract_", curr_yr))
...
indicator <- paste0("Created on ", Sys.Date(), ". Exposure to Toxic Releases Score")
