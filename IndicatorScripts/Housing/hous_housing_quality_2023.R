## Percentage of Low Quality Housing Units RC v5 ##
...
county_table_name <- "arei_hous_housing_quality_county_2023"
state_table_name <- "arei_hous_housing_quality_state_2023"
...
source <- "ACS PUMS 5-year estimates 2017-2021"
