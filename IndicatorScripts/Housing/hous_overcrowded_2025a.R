# B25014: Overcrowded Housing for RC v7a - ACS 2017-21 for MOSAIC comparison ##
#install packages if not already installed
packages <- c("dplyr","data.table","tidycensus","sf","DBI","RPostgres","RPostgres","stringr","tidyr","tigris","usethis", "here")  
...
qa_filepath <- "Asana task: https://app.asana.com/1/110506578179264/project/1208663329421768/task/1214500131777384?focus=true"

### Update these variables each year ###
curr_yr = 2021 # you MUST UPDATE each year
rc_yr <- '2025a'
rc_schema <- 'v7'
