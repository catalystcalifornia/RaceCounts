...
indicator <- paste0("Created on ", Sys.Date(), ". Rate of eviction filings per 100 renter households (weighted average) - annual average from 2014-2017. The data is")
source <- paste0("the (2000-2017) valid proprietary tract-level data downloaded from the Eviction Lab with ACS 2013-2017. https://data-downloads.evictionlab.org/#data-for-analysis/ ", curr_yr, " data. QA doc: ", qa_filepath)
