...
table_name <- "acs_5yr_b25003_multigeo_2022"
table_comment_source <- "ACS 2018-2022 5-Year Estimate Table B25003 https://data.census.gov/cedsci/. State, county, place, PUMA, tract, and ZCTA"
...
if (table_code != "DP05") {
  ...
  county_table <- d
  ###update info for postgres tables###
  county_table_name <- "arei_race_multigeo_2024"      # See most recent RC Workflow SQL Views for table name (remember to update year)
  ...
  source <- "ACS 2018-2022, Table DP05. All AIAN, All NHPI, All Latinx, all other groups are one race alone and non-Latinx."   # See most recent Indicator Methodology for source info
  rc_schema <- "v6"
}
