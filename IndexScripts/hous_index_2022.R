#### Housing Index (z-score) for RC v4 ####
...
c_index_v4 <- full_join(c_index_v4, c_8)
c_index_v4 <- full_join(c_index_v4, c_9)
c_index_v4 <- full_join(c_index_v4, c_10)
...
index_table_name <- "arei_hous_index_2022"
