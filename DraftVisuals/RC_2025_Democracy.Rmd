...
## Diversity of Candidates {.tabset .tabset-fade}
...
## Diversity of Elected Officials {.tabset .tabset-fade}
...
```{r, echo=FALSE}
c_6_chart <- county_scatterplot(c_tables[[5]])
c_6_chart
...
```{r, echo=FALSE}
  ...
  s_6_ <- state_barchart(s_tables[[5]])
  s_6_
...
c_6_long <- county_barchart(c_tables[[5]]) 
c_6_long
...
```{r, echo=FALSE}
c_5_chart <- county_scatterplot(c_tables[[7]])
c_5_chart
...
```{r, echo=FALSE}
  ...
  s_5_ <- state_barchart(s_tables[[7]])
  s_5_
...
c_5_long <- county_barchart(c_tables[[7]]) 
c_5_long
