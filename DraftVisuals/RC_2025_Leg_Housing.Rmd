...
```{r, echo=FALSE} 
sen_8_chart <- county_scatterplot(sen_tables[[7]])
sen_8_chart
...
### State Barchart
```{r, echo=FALSE}
s_8_ <- state_barchart(s_tables[[7]])
s_8_
...
```{r, echo=FALSE}
sen_8_long <- county_barchart(sen_tables[[7]]) 
sen_8_long
```
...
```{r, echo=FALSE} 
assm_8_chart <- county_scatterplot(assm_tables[[7]])
assm_8_chart
...
```{r, echo=FALSE}
assm_8_long <- county_barchart(assm_tables[[7]]) 
assm_8_long
```
