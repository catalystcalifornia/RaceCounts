...
```{r}
city_index_scatter(city_index_ba, rc_theme) %>% 
  hc_title(text = "City Composite Index")
...
city_index_scatter(city_index_sc, rc_theme) %>% 
...
city_index_scatter(city_index_sjv, rc_theme) %>% 
...
city_index_scatter(city_index_cc, rc_theme) %>% 
...
city_index_scatter(city_index_sac, rc_theme) %>% 
...
city_index_scatter(city_index_ns, rc_theme) %>% 
