...
region_urban_type <- dbGetQuery(con, paste0("SELECT geoid AS county_id, region, urban_type FROM v7.arei_multigeo_list")) # Using v5 data for now, will update later with v7 data once available
