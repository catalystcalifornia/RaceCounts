...
* All six Southern California counties have below average outcome, although 4 out 6, including Los Angeles and San Diego counties, also have below average disparities.
...
* San Francisco, with the worst outcome, is one of two counties where less than half of households own a home. It has the worst racial disparity statewide because the Asian homeownership rate is double, or close to double, that of all other groups.
* Los Angeles, with the second worst outcome, is the other county where less than half of households own a home. It has an average level of racial disparity, but the statewide patterns hold, with non-Latinx White and Asian homeownership rates being higher than other groups.
...
c_2_chart
```
* Counties with larger populations tend to have lower disparity and above average outcome in denied mortgage applications.
...
## Subprime Loans per 100 Mortgage Loan Applicants {.tabset .tabset-fade}
...
c_3_chart
```
* Six out of the eight San Joaquin Valley counties are in the Yellow Quadrant (Lower Disparity, Lower Outcome) meaning they have subprime loan rates and lower racial disparities.
...
c_5_chart
```
* San Bernardino County has the highest overall eviction filing rate (worst outcome), with higher rates for all groups (lower disparity).
* Five of the ten most disparate counties for evictions are in the Bay Area (San Francisco, Alameda, Contra Costa, San Mateo, and Santa Clara). However,these same five counties all have higher than average outcome, meaning lower overall eviction rates.
...
```
* Los Angeles ranks second in worst (outcome) in Overcrowded Housing. All of the ten counties with the worst outcome are in Southern California, Central Valley, or the Central Coast regions.
...
c_7_chart
```
* San Francisco County has the worst outcome (highest overall rate) of people living in low quality housing. Only non-Latinx White and Asian residents are less likely to have low quality housing rates below the average.
* Los Angeles County has the second worst outcome and seventh worst disparity rankings on this measure. Latinx households face the worst racial disparities on this measure by far among all groups, with 12% living in low quality housing.
...
## Forclosures {.tabset .tabset-fade}
...
c_8_chart
```
* Six out of the nine Bay Area counties are in the Purple Quadrant (High outcome, Low disparity).
...
## Housing Cost Burden (Renter) - UPDATED {.tabset .tabset-fade}
