...
```
* 9 out the 12 counties in the Red Quadrant (Higher Disparity, Lower Outcome) are in the Northern/Sierra region. Note that we do expect to see somewhat more extreme higher and lower estimates in counties, like these, with smaller populations.
