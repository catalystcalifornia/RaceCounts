...
issue_name <- 'Health Care Access' # Issues: Safety & Justice, Democracy, Economic Opportunity, Education, Healthy Built Environment, Health Care Access, Housing
issue <- 'hlth'
rc_schema <- 'v7'
rc_yr <- '2025'
acs_yr <- '2023'
...
# mutate(arei_indicator=v7_sources$arei_indicator[2], bar_chart_header=v7_sources$bar_chart_header[2], description = v7_sources$methodology[2])
