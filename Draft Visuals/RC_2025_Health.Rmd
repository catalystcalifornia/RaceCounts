...
source("./Functions/draft_visual_functions.R")
...
issue <- 'Health Care Access' # Issues: Safety & Justice, Democracy, Economic Opportunity, Education, Healthy Built Environment, Health Care Access, Housing
rc_schema <- 'v7'
rc_yr <- '2025'
acs_yr <- '2023'
...
pop <- dbGetQuery(con, paste0("SELECT geoid, total_pop, geolevel FROM ", rc_schema, ".arei_race_multigeo WHERE geolevel = 'county'"))
