...
file_name <- 'Assm_Briefs.Rmd'
#file_name <- 'Sen_Briefs.Rmd'
...
render_method <- function(geoname, date, method_list) {
  ...
  rmarkdown::render(#input = paste0("W:/Project/RACE COUNTS/", curr_yr, "_", curr_schema, "/Leg_Dist_PDFs/", geoname, ".Rmd"),
    input = here(paste0("KeyTakeaways/", file_name)),  # eg: Assm_Briefs.Rmd or Sen_Briefs.Rmd
    output_format = "html_document",
    output_file = paste0("index.html"),  
    output_dir = paste0("W:/Project/RACE COUNTS/", curr_yr, "_", curr_schema, "/Leg_Dist_PDFs/", geoname))
    #output_dir = here(paste0("Leg_Dist_PDFs/", geoname)))
