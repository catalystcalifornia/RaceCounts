---
title: "RACE COUNTS: MOSAIC Indicator Methodology"
output: 
  html_document:
...
## FONTS ## 
#font_add(family = "Rubik", regular = "W:/Project/RACE COUNTS/Style Guide/Fonts/Rubik/Rubik-Regular.ttf")
...
indicators <- function(x) {
  for(i in 1:nrow(x)) {
    ...
    cat("**Subgroup Categories:** ", x$subgroupnote[i], "\n", "\n")
    cat("**Racial-Ethnic Categories:** ", x$racenote[i], "\n", "\n")
    cat("\n")
  }
}
...
This analysis focuses on disaggregation of the Asian and Pacific Islander races. Due to data limitations, the names and number of subgroups for each indicator varies. We have used the subgroup names provided by the data source for each indicator.

To find out more about our race and ethnicity methods, please see our <a href="https://github.com/catalystcalifornia/RaceCounts/blob/main/Methodology/README_Race_Ethnicity.md" target="_blank">Race & Ethnicity Methodology</a> documentation. 
